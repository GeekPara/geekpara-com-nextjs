...
import ToolkitTopImage from '@/public/static/images/home/toolkit-top.png';
import Toolkit01Image from '@/public/static/images/home/toolkit-01.png';
import Toolkit02Image from '@/public/static/images/home/toolkit-02.png';
import Toolkit03Image from '@/public/static/images/home/toolkit-03.png';
      ...
      <div id="how-to-work" className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="pb-12 md:pb-16">
            <Image src={ToolkitTopImage} width="1104" height="325" alt="Toolkit Top Image" />
          </div>
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <Image className="md:max-w-none mx-auto rounded" src={Toolkit01Image} width="375" height="500" alt="Toolkit 01 Image" />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <Image className="md:max-w-none mx-auto rounded" src={Toolkit02Image} width="500" height="375" alt="Toolkit 02 Image" />
                  </div>
                </Transition>
                {/* Item 3 */}
                <Transition
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <Image className="md:max-w-none mx-auto rounded" src={Toolkit03Image} width="500" height="375" alt="Toolkit 03 Image" />
                  </div>
                </Transition>
              </div>
            </div>
